          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="dropdown nav-item">
              <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                <div class="photo">
                 <img :src="fotoperfil" alt="Alterar Foto">
                </div>
              ...
              <ul class="dropdown-menu dropdown-navbar">
                ...
                <li class="nav-link" @click.prevent="logOut"><a href="javascript:void(0)" class="nav-item dropdown-item">Sair</a></li>
              </ul>
            </li>
...
export default {
  ...
  mounted () {
    this.retornaFotoGravatar()
    this.$store.dispatch('cadFilialModule/indexFilialAtivas')
    // this.carregaTabmenu()
  },
  methods: {
    logOut () {
    ...
    retornaFotoGravatar: function () {
      let vm = this
      this.$store.dispatch('tblusuModule/retornaFotoGravatar', this.$store.state.auth.user.user.original.email)
        .then((res) => {
          if (res.length === 0) {
            vm.fotoperfil = res
          } else {
